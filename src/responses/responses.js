...
<code><span class='purple'>{</span>    
    ...
    lastUpdated : "2025-10-22", ${requestLimitData()}   
<span class='purple'>}</span>
</code>`,
    getSearchedEntity: `
<code><span class='purple'>{</span>
...
<code><span class='purple'>{</span>     
    ...
    isActive: true,  
    lastUpdated: '2025-10-25', ${requestLimitData()}  
<span class='purple'>}</span>
</code>`,
    getSearchedEntity: `
<code><span class='purple'>{</span>
...
<strong class='purple'>{</strong>    
    ...
    hobbies: 'Походы, бег, плавание, велосипедные прогулки, футбол, баскетбол',
    isActive: true, 
    lastUpdated: '2025-10-28', ${requestLimitData()} 
<strong class='purple'>}</strong>
</code>`,
    updateEntity: `
<code> // Код ответа: <span class='success'>200</span>.
...
<code><span class='purple'>{</span>     
    ...
    sequelTitle: null,
    multiplayer: true, 
    lastUpdated: '2025-12-06', ${requestLimitData()}  
<span class='purple'>}</span>
</code>`,
    getSearchedEntity: `
<code><span class='purple'>{</span>
...
<code><span class='purple'>{</span>        
    ...
    isSeries: false,
    seasons: null,
    lastUpdated: '2025-12-25', ${requestLimitData()}       
<span class='purple'>}</span></code>`,
    getSearchedEntity: `
<code><span class='purple'>{</span> 
    "data": <span class='purple'>[</span>        
...
<code><span class='purple'>{</span>    
    ...
    lastUpdated: '2025-12-27', ${requestLimitData()}        
<span class='purple'>}</span></code>`,
    getSearchedEntity: `
  <code><span class='purple'>{</span> 
    "data": <span class='purple'>[</span>        
...
<code><span class='purple'>{</span> 
    ...
    <span class='purple'>{</span>
        id: 1,
        login: 'DarkSeraphim',
        comment: 'Nightreign – это именно то, чего не хватало оригинальной игре. Графика на высоте, а новые механики боя делают каждую битву настоящим испытанием. Готовьтесь к ночи!',
        date: '2025-06-02',
        gameId: 1,
        userLevel: 71,
        likes: 663,        
...
<code><span class='purple'>{</span> 
    ...
    <span class='purple'>{</span>
        id: 6,
        login: 'EliteSniper',
        comment: 'Стратегия, тактика, командная работа - всё это в CS2. Игра заставляет думать на несколько шагов вперёд и быть всегда на шаг впереди противника.',
        date: '2021-04-09',
        gameId: 2,
        userLevel: 16,
        likes: 1778,        
...
<code><span class='purple'>{</span>    
    id: 2,
    login: 'BlackFlameHero',
    comment: 'Потрясающий мод, который добавляет столько нового контента, что кажется, будто игра вышла совсем недавно. Каждый элемент проработан до мелочей!',
    date: '2025-06-02',
    gameId: 1,
    userLevel: 227,
    likes: 92, ${requestLimitData()}              
<span class='purple'>}</span></code>`,
    getSearchedEntity: `
<code><span class='purple'>{</span> 
    "data": <span class='purple'>[</span>
...
export { requestLimitData, Responses };
